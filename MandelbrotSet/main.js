...
var bright;
let cont=0;
var mypalete = ['#00429d', '#174aa1', '#2552a5', '#2f5aa8', '#3962ac', '#416bb0', '#4973b3', '#517cb7', '#5884ba', '#608dbe', '#6895c1', '#6f9ec5', '#77a7c8', '#7fb0cb', '#87b8ce', '#90c1d1', '#99cad4', '#a2d3d7', '#acdbda', '#b7e4dc', '#c4ecde', '#d2f4e0', '#e4fbe1', '#ffffe0', '#fff4d7', '#ffe8cf', '#ffddc6', '#ffd1be', '#ffc6b5', '#ffb9ac', '#ffada4', '#ffa19b', '#fe9492', '#fa898b', '#f67d83', '#f1727c', '#ec6675', '#e65b6e', '#e05067', '#d94460', '#d1395a', '#c92e54', '#bf234e', '#b61849', '#ab0c43', '#9f033f', '#93003a']
...
let myWorker5 = new Worker("worker.js");
let workers = [myWorker1,myWorker2,myWorker3,myWorker4,myWorker5];
/*let myWorker5 = new Worker("worker.js");
...
myWorker1.onmessage = function(e) {
   ...
   // console.log(e.data.length);
    while(e.data.length>0){
        ...
        let pos =parseInt(n%mypalete.length);
        bright =color(mypalete[pos]);
...
function mouseClicked() {
            ...
            let dx= 0.02*(mapMaxX-mapMinX);
            let dy= 0.02*(mapMaxY-mapMinY);
